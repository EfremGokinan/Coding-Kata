export class GildedTros {
  ...
  updateQuality() {
    for (let i = 0; i < this.items.length; i++) {
      ...
      if (
        this.items[i].name != 'Good Wine' && this.items[i].name != 'Backstage passes for Re:Factor' && this.items[i].name != 'Backstage passes for HAXX'
      ) {
      ...
      if (this.items[i].sellIn < 0) {
        if (this.items[i].name != 'Good Wine') {
          ...
          if (
            this.items[i].name != 'Backstage passes for Re:Factor' && this.items[i].name != 'Backstage passes for HAXX'
          ) {
